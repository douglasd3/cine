package com.cubos.cine.views.decorators
...
open class RecyclerViewPagerDecorator : RecyclerView.ItemDecoration {
    ...
    private fun isLastItem(index: Int, recyclerView: RecyclerView) = index == (recyclerView.adapter?.itemCount
        ?: 1) - 1
}